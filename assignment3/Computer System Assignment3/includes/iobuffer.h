...
extern void config_traces(iob_option opt) ;         // configure future behaviour, default is iob_disable
...
extern void config_logs(iob_option opt) ;           // configure future behaviour, default is iob_disable
